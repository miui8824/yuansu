...
Page({
  ...
  data: {
    ...
    userid_weweima: "",
    tabmeun: [{
        path: '/pages/myRegiment/myRegiment',
        url: 'http://yscb.oss-cn-shanghai.aliyuncs.com/pro/static/img/20190703233324747.png',
        text: '我的拼团'
      },
      {
        path: '',
        url: 'http://yscb.oss-cn-shanghai.aliyuncs.com/pro/static/img/20190703233429828.png',
        text: '积分商城'
      },
      {
        path: '/pages/addressManagement/addressManagement',
        url: 'http://yscb.oss-cn-shanghai.aliyuncs.com/pro/static/img/20190703233503603.png',
        text: '收货地址'
      },
      {
        path: '',
        url: 'http://yscb.oss-cn-shanghai.aliyuncs.com/pro/static/img/20190703234219789.png',
        text: '实名认证'
      },
      {
        path: '',
        url: 'http://yscb.oss-cn-shanghai.aliyuncs.com/pro/static/img/20190703234254563.png',
        text: '帮助客服'
      },
      {
        path: '',
        url: 'http://yscb.oss-cn-shanghai.aliyuncs.com/pro/static/img/20190703234340419.png',
        text: '设置'
      }
    ]
  },
